...
namespace InventoryManagement.ViewModel
{
    public class ManageFiberViewModel : ObservableObject
    {
        ...
        public class Fiber
        {
            ...
            public Fiber(string CISCode, string InputSpec, string OutputSpec, string Length, string Quantity, string Description)
            {
        ...
        private void Add()
        {
            ...
            var product = new Fiber(CISCode, InputSpec, OutputSpec, Length, Quantity, Description);
